...
function BarraNavegacion ({ usuarioLogeado, cerrarSesion }) {
    ...
    const [vistaColombia, setVistaColombia] = useState(true)

    const locacion = useLocation()


    useEffect(() => {
      if (locacion.pathname === '/colombia') {
        setVistaColombia(true)
      } else {
        setVistaColombia(false)
      }
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 justify-between">
                  <div className="flex">
                    ...
                    <h2 className='px-4 text-lg font-bold'>ModerGIS</h2>  
                    </div>
                  ...
                  <div className="hidden sm:ml-6 sm:flex sm:items-center">
                    ...
                    <Menu as="div" className="relative ml-3">
                      ...
                      >
                        <Menu.Items className="absolute right-0 z-[1100] mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ">
                         {
                          usuarioLogeado && (
