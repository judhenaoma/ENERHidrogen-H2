    ...
    <>
        ...
        onEachFeature={(feature, layer) => {
            ...
            <div class='mx-auto w-80'>
                ...
                <i>${etiqueta}</i><br/>
                <hr class='my-3'/>
                <form  onsubmit="ejecutarCalculoGeneracionVoltaica(event, ${valorMedio})" >
                    <div>
                    ...
                    <div class="flex justify-center items-center">                       
                        <div class="mt-1 ml-1">
                            ...
                            <input id="demanda_diaria_ener" name="demanda_diaria_ener" type="number" onchange="manejoEntradaDemanda('day')" class="p-1 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div class="mt-1 mr-1">
                            <label for="demanda_anual_ener" class="block text-sm font-medium text-gray-700">Demanda anual de energía (kWh/año):</label>
                            <input id="demanda_anual_ener" name="demanda_anual_ener" type="number" onchange="manejoEntradaDemanda('year')" class="p-1 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                    <div class="mt-2">
