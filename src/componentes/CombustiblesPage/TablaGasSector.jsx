...
export function TablaGasSector({datos, titulo}) {

    const [columnas, setColumnas] = useState(null);
    const [filas, setFilas] = useState(null);
    const [filterText, setFilterText] = useState('');
    const [resetPaginationToggle, setResetPaginationToggle] = useState(false);
    const filteredItems = filas?.filter(item => item["Sector"]
    ...
    useEffect(() => {
        // columnas
        const columnas = ["Sector",	"2015",	"2016",	"2017",	"2018",	"2019",	"TACC2015-2019",	"Variacion2018-2019"]
