...
export function TablaGasMunicipio({datos, titulo}) {

    const [columnas, setColumnas] = useState(null);
    const [filas, setFilas] = useState(null);
    const [filterText, setFilterText] = useState('');
    const [resetPaginationToggle, setResetPaginationToggle] = useState(false);
    const filteredItems = filas?.filter(item => item["Municipio"]
        && item['Municipio'].toLowerCase().includes(filterText.toLowerCase()));
    ...
    useEffect(() => {
        // columnas
        const columnas = ["Municipio", "2015",	"2015",	"2016",	"2016",	"2017",	"2017",	"2018",	"2018",	"2019",	"2019",	"TACC",	"Variacion"]
